...
- [ ] **Agent 能力升级方案书 v3.0 拍板**（#38，`docs/agent/方案书-v3.0-Agent能力升级.md`）：① 分期顺序（建议 P0 起步，T1 技能包先行）② D3 sidecar/ 旧 LangGraph 遗产目录删除确认 ③ D4 runtime.tsx 650 行死代码删除确认 ④ P0 前真实 LLM 委派实测 ⑤ P3（MCP 客户端/长期记忆）是否纳入近期
