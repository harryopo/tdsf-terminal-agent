...
// TDSF: SkillContentDialog 不在此处静态 re-export，避免 streamdown 进入启动 bundle。
// 该组件仅在 SkillsPanel 内部通过 React.lazy 按需加载。
// TDSF 2026-07-28: SkillInvoker 已废弃（P0-2 方案A, 与 SkillContentDialog 功能重复且误导用户）
