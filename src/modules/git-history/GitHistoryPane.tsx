...
export function GitHistoryPane({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: filesTick is the trigger that re-reads filesCacheRef.current when the cache is bumped; without it the entry would never refresh.
