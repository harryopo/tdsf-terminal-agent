...
// 2026-07-31 起统一使用内置默认主题；2026-09-11 主题 ID 由上游命名改为 tdsf-default
...
const STORE_PATH = "tdsf-settings.json";
...
const PREFS_CHANGED_EVENT = "tdsf://prefs-changed";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  if (typeof window === "undefined" || !("__TAURI_INTERNALS__" in window)) {
    if (typeof console !== "undefined") {
      console.debug("[loadPreferences] dev mode, return defaults");
    }
...
const KEYS_CHANGED_EVENT = "tdsf://ai-keys-changed";
