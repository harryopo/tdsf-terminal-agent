            ...
            {tabs.map((t, i) => {
              ...
              const trigger = (
                ...
                >
                    ...
                    {t.kind === "editor" ? (
                      ...
                      >
                        <DropdownMenuTrigger asChild>
                          ...
                          {/* biome-ignore lint/a11y/useSemanticElements: span with role=button is intentional to avoid nested <button> inside TabsTrigger which breaks WebKit focus. */}
                          <span
                            role="button"
                            tabIndex={-1}
                            data-no-drag
                  ...
                  {tabs.length > 1 && (
                    // biome-ignore lint/a11y/useSemanticElements: span with role=button is intentional to avoid nested <button> inside TabsTrigger which breaks WebKit focus.
                    // biome-ignore lint/a11y/useFocusableInteractive: close button is focusable via parent TabsTrigger; adding tabIndex would break focus delegation.
                    // biome-ignore lint/a11y/useKeyWithClickEvents: keyboard activation is handled by parent TabsTrigger; this span only handles mouse click to stop propagation.
                    <span
                      role="button"
