...
describe("checkShellCommand — home directory rm guard", () => {
  // biome-ignore lint/suspicious/noTemplateCurlyInString: ${HOME} is a shell variable literal being tested, not a JS template placeholder.
  it("blocks rm -rf with ${HOME} (braces variant)", () => {
    // biome-ignore lint/suspicious/noTemplateCurlyInString: ${HOME} is a shell variable literal being tested.
