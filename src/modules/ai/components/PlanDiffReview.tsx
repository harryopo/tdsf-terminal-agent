  ...
  return (
    <div className="overflow-hidden rounded border border-border/40 font-mono text-[11px] leading-relaxed">
      <div className="max-h-72 overflow-auto">
        {shown.map((l, i) => (
          <div
            // biome-ignore lint/suspicious/noArrayIndexKey: diff lines are static display items that never reorder; composite key with index is sufficient for React reconciliation.
            key={`${l.kind}-${i}`}
            className={cn(
              "flex whitespace-pre",
              l.kind === "add"
